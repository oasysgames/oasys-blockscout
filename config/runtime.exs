...
config :block_scout_web, :footer,
  ...
  github_link: System.get_env("FOOTER_GITHUB_LINK", " https://github.com/oasysgames/oasys-blockscout ")
...
config :block_scout_web,
  ...
  s3_network_url: System.get_env("S3_NETWORK_URL"),
  ...
  csv_doc_link: System.get_env("CSV_DOC_LINK")
